...
require (
	...
	github.com/mevitae/redis-work-queue/autoscale/wqautoscale v0.2.0-alpha.1
...
require (
	...
	github.com/google/uuid v1.4.0 // indirect; indirect github.com/josharian/intern v1.0.0 // indirect
